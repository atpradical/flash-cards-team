...
const SvgPauseCircleOutline = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" ref={ref} {...props}>
    ...
    <g fill="currentColor" clipPath="url(#pause-circle-outline_svg__a)">
      ...
      <path d="M15 8a.99.99 0 0 0-1 1v6c0 .26.1.51.29.7a1 1 0 0 0 .71.3c.26 0 .51-.11.7-.3s.3-.44.3-.7V9a1 1 0 0 0-.3-.71A.98.98 0 0 0 15 8M9 8a.99.99 0 0 0-1 1v6c0 .26.1.51.29.7A1 1 0 0 0 9 16c.26 0 .51-.11.7-.3s.3-.44.3-.7V9a1 1 0 0 0-.3-.71A.98.98 0 0 0 9 8" />
    </g>
  </svg>
)
