...
export const pwdRecoverRequestBodyHTML = `<h1>Hello, ##name##</h1><p>Click <a href="https://flash-cards-team-atpradicals-projects.vercel.app/reset-password/##token##">here</a> to recover your password</p> If it doesn't work, copy and paste the following link in your browser:<br/>https://flash-cards-team-atpradicals-projects.vercel.app/reset-password/##token##`
